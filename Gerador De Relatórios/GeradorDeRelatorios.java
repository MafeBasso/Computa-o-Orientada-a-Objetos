...
public class GeradorDeRelatorios {
	...
	public GeradorDeRelatorios(Produto[] produtos, Algoritmo algoritmo, Criterio criterio, Filtro filtro, Object argFiltro) {
	...
	public void geraRelatorio(String arquivoSaida) throws IOException {
		algoritmo.ordena(produtos, criterio, 0, produtos.length - 1);
		...
		for (int i = 0; i < produtos.length; i++) {
			...
			if (filtro.selecionar(p, argFiltro)) {
				out.print("<li>");
	...
	public static Produto[] carregaProdutos() {
		return new Produto[] {
			new ProdutoFormatado(1, "O Hobbit", "Livros", 2, 34.90, new FormatoCor(new FormatoNegrito(new FormatoItalico(new FormatoPadrao())), new Color(255, 0, 0))),
	...
	public static void main(String[] args) {
		GeradorDeRelatorios gdr = new GeradorDeRelatorios(carregaProdutos(), new AlgoritmoInsertionSort(), new CriterioDescricaoCrescente(), new FiltroCategoriaIgualA(), "Livros");
		try {
