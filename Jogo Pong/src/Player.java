...
public class Player {
	...
	*/
	...
	public void moveUp(long delta){
		...
		if (GameLib.isKeyPressed(6) == true || GameLib.isKeyPressed(8) == true) {
			if ((v_limit[0] + (height / 2)) < newCy) cy = newCy;
			else cy = (v_limit[0] + (height / 2));
		}
	}
	...
	*/
	...
	public void moveDown(long delta){
		double newCy = cy + (speed * delta);
		if (GameLib.isKeyPressed(7) == true || GameLib.isKeyPressed(9) == true) {
			if ((v_limit[1] - (height / 2)) > newCy) cy = newCy;
			else cy = (v_limit[1] - (height / 2));
		}
	}
